...
| Request `Content-Digest` header | input | Requirement: Content-digest manifest check (`matching-content-digest-accepted`, `mismatched-content-digest-401`); request direction only |
