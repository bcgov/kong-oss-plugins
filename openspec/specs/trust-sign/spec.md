...
**ID**: `trust-sign.request-manifest-signing.signature-header-key-unset-runtime-failure`
...
#### Scenario: Kong-generated responses are not signed

**ID**: `trust-sign.response-manifest-signing.kong-generated-responses-not-signed`

- **WHEN** the response is generated by Kong itself rather than the upstream service (e.g. a Kong error response or an early exit from another plugin)
- **THEN** the plugin adds neither a signature header nor a `Content-Digest` header to the response
