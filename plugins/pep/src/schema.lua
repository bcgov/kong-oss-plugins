      ...
      config = {
        ...
        fields = {
          ...
          },
          {
            result_type = {
              type = "string",
              description = "The type of the located result, either 'decision' or 'table', which determines how the plugin will interpret the located value",
              default = "decision",
              one_of = {"decision", "table"}
            }
          }
        },
        entity_checks = {
